...
public enum CSubmenuDownloaders implements ICDoc {
    ...
    private final UiCommand cmdCheckForUpdates = () -> new AutoUpdater(false).attemptToUpdate(CompletableFuture.supplyAsync(() -> RSSReader.getCommitLogViaApi(GBF_UPDATE_REPO, FControl.instance.getBuildTimeStamp(), FControl.instance.getSnapsTimestamp())));
